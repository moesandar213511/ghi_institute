                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="duration" class="form-control" id="duration" required rows="1"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="category" id="category" class="form-control">
                                                    ...
                                                    <option value="academic">Academin</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="start_date" class="form-control" id="update_start_date" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="update_duration">Duration</label>
                                                <textarea name="duration" class="form-control" id="update_duration" required rows="1"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
            ...
            $('#insert_course').on('submit',function (e)
            {
                ...
                ({
                    ...
                    success: function(data){
                        ...
                        $('#modalBox').modal('hide');
                        toastr.success('Insert course data successful');
                        load();
                    }
                });
                return false;
            ...
            edit_data=function(id){
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        $('#update_name').val(course['name']);
                        $('#update_start_date').val(course['start_date']);
                        $('#update_duration').val(course['duration']);
                        $('#update_fee').val(course['fee']);
                        $('#update_category').val(course['category']);
                        ...
                        $('#update_description').summernote('code',course['description']);
            ...
            $('#update_data').on('submit',function (e)
            {
                ...
                ({
                    ...
                    success: function(data){
                        ...
                        toastr.success('Update course data successful');
                        load();
                    }
                });
                return false;
            ...
            delete_data=function(id){
                if(confirm('Are you sure You want to delete!')==true){
                    $.ajax({
                        ...
                        cache: false,
                        success: function(data){
                            toastr.success('Delete course data successful');
                            load();
                        }
                    });
                }else{
