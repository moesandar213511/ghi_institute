                ...
                <div class="section-inner">
                    <div class="container">
                        <div class="row normal-sidebar">
                            ...
                            <!--        <div class="textwidget">-->
                            <!--            <p>Email: email-us@example.com<br>Telephone: 0123 456 789<br>-->
                            ...
                            <div class=" col-md-3  widget widget-text">
                                <div class=" widget-inner">
                                    <h2 class="widget-title maincolor1">GREEN HACKERS INSTITUTE</h2>
                                    <div class="textwidget" style="text-align:justify;">The Green Hackers Institute was established in 2019 to teach information technology and engineering with global standards.GHI Myanmar generates the knowledge to our student that to be competitive globally and to apply and stand that in their work with dignity.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class=" col-md-3  widget widget-recent-entries">
                                <div class=" widget-inner">
                                    <h2 class="widget-title maincolor1">RECENT BLOGS</h2>
                                    <ul>
                                        @foreach($recent_blogs as $recent_blog)
                                        <li>
                                            <a href="{{url('blogSingle/'.$recent_blog->id)}}">{{$recent_blog->name}}</a>
                                        </li>
                                        @endforeach
                                    </ul>
                                </div>
                            ...
                            <div class=" col-md-3  widget widget-nav-menu">
                                <div class=" widget-inner">
                                    <h2 class="widget-title maincolor1">QUICK LINKS</h2>
                                    <div class="menu-others-container">
                                        <ul id="menu-others" class="menu">
                                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1306">
                                                <a href="{{url('/courseList')}}">Our Courses</a>
                                            </li>
                                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1307"><a href="{{url('/blogList')}}">Our Blog</a></li>
                                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1308"><a href="{{url('/eventList')}}">Our Event</a></li>
                                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1309"><a href="{{url('/member')}}">Our Member</a></li>
                                            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1310"><a href="{{url('/contact')}}">Our Contact</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container">
                    ...
                    <div class="row footer-content">
                        <div class="copyright col-md-6">
                            &copy; <script>let date = new Date;document.write(date.getFullYear());</script> Power By<a href="https://www.facebook.com/greenhackersinstitute/"> Green Hackers Institute</a>. All rights reserved.
                        </div>
                        <nav class="col-md-6 footer-social">
                            <ul class="social-list">
                                <li>
                                    <a href="https://www.facebook.com/greenhackersinstitute/" target="_blank" class="btn btn-default social-icon">
